var plugins = [{
      plugin: require('/Users/kota/dev/repositories/blog/node_modules/gatsby-plugin-feed/gatsby-ssr'),
      options: {"plugins":[],"query":"\n          {\n            site {\n              siteMetadata {\n                site_url: url\n                title\n                description: subtitle\n              }\n            }\n          }\n        ","feeds":[{"query":"\n              {\n                allMarkdownRemark(\n                  limit: 1000,\n                  sort: { order: DESC, fields: [frontmatter___date] },\n                  filter: { frontmatter: { template: { eq: \"post\" }, draft: { ne: true } } }\n                ) {\n                  edges {\n                    node {\n                      html\n                      fields {\n                        slug\n                      }\n                      frontmatter {\n                        title\n                        date\n                        template\n                        draft\n                        description\n                      }\n                    }\n                  }\n                }\n              }\n            ","output":"/rss.xml","title":"kota-yata"}]},
    },{
      plugin: require('/Users/kota/dev/repositories/blog/node_modules/gatsby-remark-autolink-headers/gatsby-ssr'),
      ...
      plugin: require('/Users/kota/dev/repositories/blog/node_modules/gatsby-plugin-manifest/gatsby-ssr'),
      ...
      plugin: require('/Users/kota/dev/repositories/blog/node_modules/gatsby-plugin-offline/gatsby-ssr'),
      ...
      plugin: require('/Users/kota/dev/repositories/blog/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      plugin: require('/Users/kota/dev/repositories/blog/gatsby-ssr'),
      options: {"plugins":[]},
    }]
